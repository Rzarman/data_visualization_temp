...
import renderPracChart from './charts/pracCharts';
...
class AdminatorApp {
  ...
  initCharts() {
    ...
    const hasEcharts = DOM.exists('#voltage-chart');
    ...
    if (hasCharts) {
      ...
      this.components.set('charts', charts);
		...
		if(hasEcharts){
			const pracChartInstance = renderPracChart('voltage-chart');
			this.components.set('pracChart', pracChartInstance);
		}
